...
import { LevelsList, LevelsCreate, LevelsEdit } from './resources/Levels';
import LevelsIcon from '@mui/icons-material/Gamepad';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/aa2228a64">
      <Admin
        authProvider={
      ...
      >
        <Resource
          name="Levels"
          options={{ label: 'Levels' }}
          list={LevelsList}
          create={LevelsCreate}
          edit={LevelsEdit}
          recordRepresentation="levelNumber"
          icon={LevelsIcon}
        />
